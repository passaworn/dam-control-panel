...
/** @class */
function (_super) {
  SimpleCtrl.$inject = ["$scope", "$injector", "$rootScope"];

  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SimpleCtrl, _super);
  /** @ngInject */


  function SimpleCtrl($scope, $injector, $rootScope) {
    ...
    _this.firstValues = [];
    _this.time = 'timenull';
    lodash_defaultsDeep__WEBPACK_IMPORTED_MODULE_2___default()(_this.panel, _this.panelDefaults); // _.defaults(this.panel, examples[0].config);
  ...
  SimpleCtrl.prototype.onInitEditMode = function () {
    ...
    this.chkNull(); // console.log(this.$rootScope);
  };
  ...
  SimpleCtrl.prototype.onPanelInitalized = function () {
    this.updateTemplate(); // console.log('onInit');
  ...
  SimpleCtrl.prototype.onConfigChanged = function () {
    this.refresh();
  };

  SimpleCtrl.prototype.updateTemplate = function () {
    this.isRelay = this.panel.damOptions.control === 'relay';
    this.isMqtt = this.panel.damOptions.control === 'mqtt';
  };

  SimpleCtrl.prototype.modeChanged = function (value) {
    if (value !== 'relay') {
  ...
  SimpleCtrl.prototype.link = function (scope, elem, attrs, ctrl) {
    ...
    // const image = (panelContainer.querySelector('#imageit-image'));
    this.events.on('render', function () {// const $panelGrid2 = elem.closest('#dam-grid');
  ...
  SimpleCtrl.prototype.chkNull = function () {
  ...
  SimpleCtrl.prototype.calFontSize = function () {
    var pixelSize = parseInt(this.panel.valueFontSize, 10) / 100 * BASE_FONT_SIZE;
    this.panel.fontSize = pixelSize + 'px';
    this.render();
  };

  SimpleCtrl.prototype.calFontSize2 = function () {
    var pixelSize = parseInt(this.panel.valueFontSize2, 10) / 100 * BASE_FONT_SIZE;
    this.panel.fontSize2 = pixelSize + 'px';
    this.render();
  };

  SimpleCtrl.prototype.sendData = function (switchONOFF) {
    var _this = this;

    this.panel.loading = true; //   this.render();
    //   this.refresh();

    if (this.panel.damOptions.control === 'relay') {
      // ถ้าเป็น relay แบบ ON,OFF
      if (this.panel.damOptions.mode !== 'toggle') {
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.panel.damUrl, {
          key: 'relay',
          ...
          var alertText = "Relay " + _this.panel.damOptions.relayChanel + " : " + _this.panel.damOptions.mode;

          _this.$rootScope.appEvent('alert-success', ['Success', alertText]);
        })["catch"](function (error) {
          _this.panel.loading = false;
          console.log(error.response);

          _this.$rootScope.appEvent('alert-error', ['Error', error.response]);
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.panel.damUrl, {
          ...
          _this.panel.loading = false;
          _this.panel.switchButton = !_this.panel.switchButton;
          console.log(response);
          var alertText = "Relay " + _this.panel.damOptions.relayChanel + " : " + _this.panel.valueSwitch;
      ...
      if (this.panel.damOptions.switchMode === 'trigger') {
        if (this.panel.damOptions.control !== 'mqtt') {
          axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.panel.damUrl, {
            ...
            _this.panel.loading = false;
            console.log(response);
            var alertText = "Trigger " + _this.panel.damOptions.control;
        ...
        if (this.panel.damOptions.control !== 'mqtt') {
          axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.panel.damUrl, {
            ...
            _this.panel.switchButton = !_this.panel.switchButton;
            console.log(response);
            var valSW = _this.panel.switchButton ? 'ON' : 'OFF';
            var alertText = "Toggle " + valSW + " " + _this.panel.damOptions.control;

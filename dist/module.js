...
function (_super) {
  ...
  SimpleCtrl.prototype.onInitEditMode = function () {
    ...
    this.chkNull();
    this.calFontSize();
    this.calFontSize2(); // console.log(this.$rootScope);
  };
  ...
  SimpleCtrl.prototype.sendData = function (switchONOFF) {
    ...
    var isTroggle = false; //   this.render();
    //   this.refresh();
  ...
  SimpleCtrl.prototype.postData = function (control, isTroggle, data) {
    var _this = this;

    axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.panel.damUrl, data).then(function (response) {
